...
/* harmony export */   "TESTIMONY_SLIDE": () => (/* binding */ TESTIMONY_SLIDE)
/* harmony export */ });
const TESTIMONY_SLIDE = {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _validators__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validators */ "./src/modules/forms/validators/index.js");
/* harmony import */ var _debounce__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./debounce */ "./src/modules/forms/debounce.js");
...
class FormValidator {
  constructor() {
    ...
    if (this.form) {
      ...
      this.form.addEventListener("input", (0,_debounce__WEBPACK_IMPORTED_MODULE_1__["default"])(this.onInput.bind(this)));
    }
  }
  ...
  isStepValid(step) {
    ...
    switch (step) {
      case 0:
        isStepValid = (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.fullname) && (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkPhone)(this.phone) && (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkEmail)(this.email);
        break;
      case 1:
        isStepValid = (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.goal) && (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.goalTime);
        break;
      case 2:
        isStepValid = (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.healthState);
        break;
      case 3:
        isStepValid = (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.motivation);
        break;
      default:
        isStepValid = true;
        break;
  ...
  onFormSubmit(e) {
    ...
    // validate forms
    let isNameValid = (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.fullname),
      isPhoneValid = (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkPhone)(this.phone),
      isEmailAddressValid = (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkEmail)(this.email),
      isGoalValid = (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.goal),
      isGoalTimeValid = (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.goalTime),
      isHealthStateValid = (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.healthState),
      isMotivationValid = (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.motivation);
    //isRecaptchaTokenValid = checkField(this.recaptchaToken);

    let isFormValid = isNameValid && isEmailAddressValid && isGoalValid && isPhoneValid && isGoalTimeValid && isHealthStateValid && isMotivationValid;
  ...
  onInput(e) {
    if (e.target.id === "fullname") {
      (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.fullname);
    } else if (e.target.id === "phone") {
      (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkPhone)(this.phone);
    } else if (e.target.id === "email") {
      (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkEmail)(this.email);
    } else if (e.target.id === "goal") {
      (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.goal);
    } else if (e.target.id === "goalTime") {
      (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.goalTime);
    } else if (e.target.id === "healthState") {
      (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.healthState);
    } else if (e.target.id === "motivation") {
      (0,_validators__WEBPACK_IMPORTED_MODULE_0__.checkField)(this.motivation);
    }
  }
  async sendEmail() {
...
/***/ "./src/modules/forms/validators/email.js":
/*!***********************************************!*\
  !*** ./src/modules/forms/validators/email.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ */ "./src/modules/forms/validators/index.js");
...
const checkEmail = email => {
  ...
  if (!(0,___WEBPACK_IMPORTED_MODULE_0__.isRequired)(emailAddress)) {
    (0,___WEBPACK_IMPORTED_MODULE_0__.showError)(email, "Courriel requis");
  } else if (!isEmailValid(emailAddress)) {
    (0,___WEBPACK_IMPORTED_MODULE_0__.showError)(email, "Courriel invalide");
  } else {
    (0,___WEBPACK_IMPORTED_MODULE_0__.showSuccess)(email);
    valid = true;
  }
  return valid;
};
...
/***/ "./src/modules/forms/validators/index.js":
/*!***********************************************!*\
  !*** ./src/modules/forms/validators/index.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "checkEmail": () => (/* reexport safe */ _email__WEBPACK_IMPORTED_MODULE_0__["default"]),
/* harmony export */   "checkField": () => (/* reexport safe */ _is_required__WEBPACK_IMPORTED_MODULE_2__.checkField),
/* harmony export */   "checkPhone": () => (/* reexport safe */ _phone__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   "isRequired": () => (/* reexport safe */ _is_required__WEBPACK_IMPORTED_MODULE_2__.isRequired),
/* harmony export */   "showError": () => (/* reexport safe */ _message_toggler__WEBPACK_IMPORTED_MODULE_3__.showError),
/* harmony export */   "showSuccess": () => (/* reexport safe */ _message_toggler__WEBPACK_IMPORTED_MODULE_3__.showSuccess)
/* harmony export */ });
/* harmony import */ var _email__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./email */ "./src/modules/forms/validators/email.js");
/* harmony import */ var _phone__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./phone */ "./src/modules/forms/validators/phone.js");
/* harmony import */ var _is_required__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./is-required */ "./src/modules/forms/validators/is-required.js");
/* harmony import */ var _message_toggler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./message-toggler */ "./src/modules/forms/validators/message-toggler.js");
...
/***/ "./src/modules/forms/validators/is-required.js":
/*!*****************************************************!*\
  !*** ./src/modules/forms/validators/is-required.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _message_toggler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./message-toggler */ "./src/modules/forms/validators/message-toggler.js");
...
const checkField = field => {
  ...
  if (!isRequired(name)) {
    (0,_message_toggler__WEBPACK_IMPORTED_MODULE_0__.showError)(field, "Champs requis");
  } else {
    (0,_message_toggler__WEBPACK_IMPORTED_MODULE_0__.showSuccess)(field);
    valid = true;
  }
  return valid;
};
...
/***/ "./src/modules/forms/validators/message-toggler.js":
/*!*********************************************************!*\
  !*** ./src/modules/forms/validators/message-toggler.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/modules/forms/validators/phone.js":
/*!***********************************************!*\
  !*** ./src/modules/forms/validators/phone.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const checkPhone = phone => {
  ...
  if (!(0,___WEBPACK_IMPORTED_MODULE_0__.isRequired)(phoneNumber)) {
    (0,___WEBPACK_IMPORTED_MODULE_0__.showError)(phone, "Champs requis");
  } else if (!isPhoneValid(phoneNumber)) {
    (0,___WEBPACK_IMPORTED_MODULE_0__.showError)(phone, "Numéro de téléphone invalide");
  } else {
    (0,___WEBPACK_IMPORTED_MODULE_0__.showSuccess)(phone);
    valid = true;
  }
  return valid;
};
...
class Search {
  ...
  async getSearchResults() {
    const data = await fetch(`${clnrgyData.root_url}/wp-json/clnrgy/v1/blog-search?term=${this.searchTerm.value}`);
...
/* harmony import */ var _modules_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/forms */ "./src/modules/forms/index.js");
...
const form = new _modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"]();
...
const testimonialSlider = new _modules_slider__WEBPACK_IMPORTED_MODULE_2__["default"](_constant__WEBPACK_IMPORTED_MODULE_4__.TESTIMONY_SLIDE.selector, _constant__WEBPACK_IMPORTED_MODULE_4__.TESTIMONY_SLIDE.config);
})();
