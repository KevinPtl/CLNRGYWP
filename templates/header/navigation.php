<nav id="main-nav">
    <ul id="main-nav-list">
        <!-- <li><a id="nav-link-about-us" href="https://boutique.clnrgy.com/">Boutique</a></li> -->
        <li><a id="nav-link-about-us" <?php if(is_page('a-propos')) echo 'class="active"'?> href="<?php echo site_url('/a-propos') ?>">À propos</a></li>
        <li><a id="nav-link-success-stories" <?php if(is_page('temoignages')) echo 'class="active"'?> href="<?php echo site_url('/temoignages') ?>">Témoignages</a></li>
        ...
        <li><a id="nav-link-blog" <?php if(get_post_type() == "post") echo 'class="active"'?> href="<?php echo site_url('/blogue') ?>">Blogue</a></li>
